...
Chay:
  venv\\Scripts\\python.exe docs\\demo_vector_search.py
  venv\\Scripts\\python.exe docs\\demo_vector_search.py --compare
  venv\\Scripts\\python.exe docs\\demo_vector_search.py --demo
"""
